...
gpg --detach-sign --armour --sign-with 0xC1B4C74A5918E4DE ${PACKAGE}.zip
gpg --detach-sign --armour --sign-with 0xC1B4C74A5918E4DE ${PACKAGE}.sh
#gpg --detach-sign --armour --sign-with 0x811D6940E1E4240C ${PACKAGE}.exe

gpg --clearsign --sign-with 0xC1B4C74A5918E4DE ${CHANGELOG}
rm -f ${CHANGELOG}
